...
| Format | Link |
|--------|------|
| **PDF** | [**Download RGR Standard v0.55-draft (PDF)**](https://github.com/cloudficient/reconstruction-grade-ediscovery-standard/releases/latest/download/rgr-standard-0.55-draft.pdf) |
...
| `VERSION` | Current version identifier (e.g., `0.55-draft`) |
...
> Reconstruction-Grade eDiscovery Standard, v0.55-draft, Section 3.2, Cloudficient (2026).
